...
If you want to know about the extented Markdown syntax of **DoIt** theme, please read [extended Markdown syntax page](exampleSite/content/posts/theme-documentation-content#extended-markdown-syntax).
{{< /admonition >}}
...
{{< admonition tip >}}
**DoIt** theme has [special shortcode for image](exampleSite/content/posts/theme-documentation-extended-shortcodes#image), which provides more features.
{{< /admonition >}}
